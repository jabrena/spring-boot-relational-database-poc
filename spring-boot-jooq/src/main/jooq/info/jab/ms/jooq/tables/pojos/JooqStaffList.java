...
public class JooqStaffList implements Serializable {
    ...
    public JooqStaffList() {}

    public JooqStaffList(JooqStaffList value) {
        this.id = value.id;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final JooqStaffList other = (JooqStaffList) obj;
        if (this.id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("JooqStaffList (");
