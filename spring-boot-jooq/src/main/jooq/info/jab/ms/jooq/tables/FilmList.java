...
import info.jab.ms.jooq.tables.records.FilmListRecord;
...
public class FilmList extends TableImpl<FilmListRecord> {
     ...
     */
    public final TableField<FilmListRecord, MpaaRating> RATING = createField(DSL.name("rating"), SQLDataType.VARCHAR.asEnumDataType(info.jab.ms.jooq.enums.MpaaRating.class), this, "");
